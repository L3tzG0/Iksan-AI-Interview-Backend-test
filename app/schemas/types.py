...
data conversion patterns for PostgreSQL responses.
"""
...
def parse_flexible_datetime(value: Union[str, datetime, None]) -> datetime | None:
    ...
    - ISO 8601 strings from PostgreSQL (e.g., '2025-11-28T07:30:41.729031+00:00')
    ...
    if isinstance(value, str):
        # Handle ISO format strings from PostgreSQL
...
# Use this instead of `datetime` in Pydantic models that receive data from PostgreSQL
