  ...
  const handleDownloadPdf = async () => {
    ...
    try {
      ...
      if (studentMeta) {
        ...
        addKeyValue('이름', studentMeta.name || 'N/A');
        addKeyValue('학교', studentMeta.schoolName || 'N/A');
        addKeyValue('학년', studentMeta.grade ? `${studentMeta.grade}` : 'N/A');
        addKeyValue('전공', studentMeta.major || 'N/A');
      }
