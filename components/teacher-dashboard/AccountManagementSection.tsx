...
const AccountManagementSection: FC<AccountManagementSectionProps> = ({
    ...
    const lastGeneratedAccountId = useRef<string | null>(
        generatedAccount?.studentId ?? null
    );
    ...
    useEffect(() => {
        ...
        if (
            currentId &&
            currentId !== lastGeneratedAccountId.current &&
            isCreateModalOpen
        ) {
        ...
        <>
            ...
            {generatedAccount && (
                <div className="bg-primary-lightest/70 px-4 py-3 border border-primary/30 rounded-2xl text-slate-800 text-sm">
                    ...
                    <p className="font-mono text-slate-900">
                        PW: {generatedAccount.tempPassword}
                    </p>
                                ...
                                {isStudentTableLoading &&
                                    userList.length === 0 && (
                                        <tr>
                                            <td
                                                colSpan={4}
                                                className="px-6 py-6 text-slate-400 text-center"
                                            >
                        ...
                        >
                            ...
                            <div className="flex flex-wrap items-center gap-2">
                                ...
                                <input
                                    ...
                                    accept=".csv"
                                    onChange={(e) =>
                                        onBulkFileChange(e.target.files?.[0])
                                    }
                                />
                                <Button
                                    variant="secondary"
                                ...
                                <div className="space-y-2 mt-3">
                                    ...
                                    <div className="bg-white border border-slate-200 rounded-lg max-h-56 overflow-auto">
                                        ...
                                        {bulkPreview.length > 5 && (
                                            <p className="px-2 py-1 text-[10px] text-slate-400">
                                                + {bulkPreview.length - 5}개 더
                                            </p>
                                        )}
                                    </div>
                                    <Button
                                        onClick={onBulkSubmit}
                                        disabled={!canSubmitBulkUpload}
                                    ...
                                    {backendErrors.length > 0 && (
                                        <div className="text-red-600 text-xs">
                                            ...
                                            <Button
                                                variant="secondary"
                                                onClick={onBackendErrorDownload}
                                    ...
                                    {bulkUploadSummary && (
                                        <div className="text-slate-600 text-xs">
                                            ...
                                            <p>
                                                {bulkUploadSummary.created}/
                                                {bulkUploadSummary.total} 개
                                                등록
                                            </p>
                                        </div>
                                    )}
